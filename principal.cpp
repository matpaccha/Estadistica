...
void Principal::dibujar()
{
  ...
  lienzo.fill(Qt::white);
    ...
    int y=50;
    int ancho =  100;
    int Titulo_1 = ui->inTitulo1->value();
    int Titulo_2 = ui->inTitulo2->value();
    int Titulo_3 = ui->inTitulo3->value();
    ...
    for (int o=x; o<450; o+=100) {
        QString nota1 = "Grafica 1";
        painter.drawText(x+25, y+415, nota1);
        QString nota2 = "Grafica 2";
        painter.drawText(x+180, y+415, nota2);
        QString nota3 = "Grafica 3";
    ...
    painter.drawRect(x,y+(400-Titulo_1),ancho, Titulo_1);
    ...
    painter.drawRect(x+150,y+(400-Titulo_2),ancho, Titulo_2);
    ...
    painter.drawRect(x+300,y+(400-Titulo_3), ancho, Titulo_3);
